...
export const copy = {
  ...
  /* ---- provider detail (reference-style list + pane) ---- */
  providerList: '供应商',
  groupCatalog: '内置目录',
  groupCustom: '自定义',
  selectProviderHint: '从左侧选择一个供应商查看与编辑配置。',
  providerEnabled: '启用该供应商',
  rename: '重命名',
  menu: '更多操作',
  /* ---- model editor modal (reference: 编辑模型配置) ---- */
  modelModalTitle: '编辑模型配置',
  modelModalCreate: '新建模型',
  smartConfig: '智能配置',
  smartConfigHint: '按模型 ID 从 pi 内置目录自动补全仍为空的字段',
  smartNoMatch: 'pi 内置目录没有这个模型 ID，未做补全',
  smartNothingToFill: '已匹配到模型；可补全的字段都已有值',
  advancedConfig: '高级配置',
  modelNameOptional: '可选，留空则显示模型 ID',
  inputTypes: '输入类型',
  textInput: '文本',
  textAlwaysOn: '文本输入始终启用',
  imageInput: '图片',
  videoInput: '视频',
  audioInput: '音频',
  pdfInput: 'PDF',
